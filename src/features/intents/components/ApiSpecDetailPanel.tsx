  ...
  return (
    <div className="space-y-5">
      ...
      {spec.status === ApiSpecStatus.Failed && spec.parseError && (
        <div className="flex items-start gap-3 p-4 rounded-xl bg-danger-soft border border-danger/15">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border-subtle">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-danger-soft border border-danger/[0.12] text-xs font-semibold text-danger hover:brightness-110 transition-all"
            >
          ...
          <div className="px-6 py-3 border-b border-border-subtle">
            ...
            <div className="flex flex-wrap gap-2">
              {baseUrls.map((url, i) => (
                <span
                  key={i}
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-info-soft border border-info/[0.12] text-xs font-mono text-info"
                >
          ...
          <div className="px-6 py-3 border-b border-border-subtle">
            ...
            <div className="flex flex-wrap gap-2">
              {Object.entries(securitySchemes).map(([name, scheme]) => (
                <span
                  key={name}
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-warning-soft border border-warning/[0.12] text-xs font-bold text-warning"
                >
